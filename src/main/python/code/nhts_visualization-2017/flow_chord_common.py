...
DETAILED_ORDER = [
    "Home",  "Personal business", "Work", "Restaurant", "Recreation", "School",   "Shopping",
     "Medical", "Escort",  "Other", 
]
DETAILED_COLORS = {
    "Home": "#1f77b4",
    "Work": "#f2a65a",
...
# 2017 NHTS WHYFROM and WHYTO detailed activity codes. The mapping is
# location-oriented so code 2, paid work from home, remains in Home for
# comparison with simulation place types.
...
NHTS_2017_COMPARABLE_ACTIVITY_MAP = {
    code: label
    for code, label in NHTS_2017_DETAILED_ACTIVITY_MAP.items()
    if label in COMPARABLE_ORDER
}
...
def plot_directed_chord(
    ...
    for i, label in enumerate(labels):
        ...
        ax.text(
            ...
            ha="center", va="center", fontsize=16, color="#111111", zorder=5, linespacing=1.2,
        )
